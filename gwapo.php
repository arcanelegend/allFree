...
<html>
  <head>
    ...
    <link rel="icon" href="flightsalesL.jpg" type="image/gif" sizes="16x16">
  </head>
<style type="text/css">
*{
  margin: 0;
...
<div class="input-group">
  <label>Message:</label>
      ...
      <textarea name="message" style="margin: 0px; height: 192px; width: 361px;"></textarea>
      <br>
